...
class AppItem extends React.Component< DemoProps, DemoState > {
    render = () => {
...
class CardItem extends React.Component< DemoProps, DemoState > {
    render = () => {
        const app = this.props.app;
    ...
    render = () => {
        return <div className="mbsc-padding">
            ...
            <mobiscroll.ScrollView layout="fixed" itemWidth={134} snap={false}>
                {this.props.birds.map(function(app: any) {
            ...
            <div className="mbsc-grid">
                <div className="mbsc-row mbsc-justify-content-center mbsc-no-padding">
                    {this.props.animals.map(function(app: any) {
